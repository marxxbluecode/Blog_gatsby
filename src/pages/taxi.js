...
export default function Project() {
    ...
    const { imgproject, title, paragraph, imgbtn, back } = data.datablog.taxis[0];
    ...
    return(
        ...
        <Header />
        <S.Container>
        <Link to="https://hopeful-colden-a4b3bd.netlify.app/"><S.Img src={imgproject.url} alt="project icon"/></Link>
