...
export default function Project() {
    ...
    const { imgproject, title, paragraph, imgbtn, back } = data.datablog.streamings[0];
    ...
    return(
        ...
        <Header />
        <S.Container>
        <Link to="https://hopeful-brattain-735762.netlify.app/"><S.Img src={imgproject.url} alt="project icon"/></Link>
