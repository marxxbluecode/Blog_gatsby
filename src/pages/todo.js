...
export default function Project() {
    ...
    const { imgproject, title, paragraph, imgbtn, back } = data.datablog.todos[0];
    ...
    return(
        ...
        <Header />
        <S.Container>
        <Link to="https://sleepy-jang-1d4027.netlify.app/"><S.Img src={imgproject.url} alt="project icon"/></Link>
