...
export default function Project() {
    ...
    const { imgproject, title, paragraph, imgbtn, back } = data.datablog.cars[0];
    ...
    return(
        ...
        <Header />  
        <S.Container>
                <Link to="https://vibrant-einstein-479cc5.netlify.app/"><S.Img src={imgproject.url} alt="project icon"/></Link>
