...
export default function Project() {
    ...
    const { imgproject, title, paragraph, imgbtn, back } = data.datablog.vaporwaves[0];
    ...
    return(
        ...
        <Header />
        <S.Container>
        <Link to="https://nervous-jackson-095925.netlify.app/"><S.Img src={imgproject.url} alt="project icon"/></Link>
